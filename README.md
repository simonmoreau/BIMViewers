...
Using the `@dangl/xbim-viewer` npm package and the [xBIM Meets Angular](https://github.com/GeorgDangl/xbim-meets-angular) project.

Dans `generators\xBIM`, a small console application convert an IFC file into a wexBIM file.
